...
namespace UnitsNet
{
    ...
    public sealed partial class Volume : IQuantity
    {
        ...
        /// <exception cref="ArgumentException">If value is NaN or Infinity.</exception>
        [Windows.Foundation.Metadata.DefaultOverload]
        public static Volume FromDecs(double decs)
        {
        ...
        private double AsBaseUnit()
        {
            switch(Unit)
            {
                case VolumeUnit.AcreFoot: return _value*(43560*0.3048*0.3048*0.3048);
                case VolumeUnit.AuTablespoon: return _value*2e-5;
                case VolumeUnit.BoardFoot: return _value*(0.3048*0.3048*0.0254);
                ...
                case VolumeUnit.CubicFoot: return _value*(0.3048*0.3048*0.3048);
                case VolumeUnit.CubicHectometer: return _value*1e6;
                case VolumeUnit.CubicInch: return _value*(0.0254*0.0254*0.0254);
                ...
                case VolumeUnit.CubicMile: return _value*(5280.0*5280.0*5280.0*0.3048*0.3048*0.3048);
                case VolumeUnit.CubicMillimeter: return _value/1e9;
                case VolumeUnit.CubicYard: return _value*(3*3*3*0.3048*0.3048*0.3048);
                case VolumeUnit.Dec: return _value/1000;
                case VolumeUnit.DecausGallon: return (_value*(231*0.0254*0.0254*0.0254)) * 1e1d;
                case VolumeUnit.Deciliter: return (_value/1e3) * 1e-1d;
                case VolumeUnit.DeciusGallon: return (_value*(231*0.0254*0.0254*0.0254)) * 1e-1d;
                case VolumeUnit.HectocubicFoot: return (_value*(0.3048*0.3048*0.3048)) * 1e2d;
                case VolumeUnit.HectocubicMeter: return (_value) * 1e2d;
                case VolumeUnit.Hectoliter: return (_value/1e3) * 1e2d;
                case VolumeUnit.HectousGallon: return (_value*(231*0.0254*0.0254*0.0254)) * 1e2d;
                case VolumeUnit.ImperialBeerBarrel: return _value*0.16365924;
                case VolumeUnit.ImperialGallon: return _value*0.00454609;
                case VolumeUnit.ImperialOunce: return _value*(0.00454609*1/160);
                case VolumeUnit.ImperialPint: return _value * 5.6826125e-4;
                case VolumeUnit.KilocubicFoot: return (_value*(0.3048*0.3048*0.3048)) * 1e3d;
                case VolumeUnit.KilocubicMeter: return (_value) * 1e3d;
                case VolumeUnit.KiloimperialGallon: return (_value*0.00454609) * 1e3d;
                case VolumeUnit.Kiloliter: return (_value/1e3) * 1e3d;
                case VolumeUnit.KilousGallon: return (_value*(231*0.0254*0.0254*0.0254)) * 1e3d;
                case VolumeUnit.Liter: return _value/1e3;
                case VolumeUnit.MegacubicFoot: return (_value*(0.3048*0.3048*0.3048)) * 1e6d;
                case VolumeUnit.MegaimperialGallon: return (_value*0.00454609) * 1e6d;
                case VolumeUnit.Megaliter: return (_value/1e3) * 1e6d;
                case VolumeUnit.MegausGallon: return (_value*(231*0.0254*0.0254*0.0254)) * 1e6d;
                ...
                case VolumeUnit.OilBarrel: return _value*(42*231*0.0254*0.0254*0.0254);
                case VolumeUnit.UkTablespoon: return _value*1.5e-5;
                case VolumeUnit.UsBeerBarrel: return _value*(31*231*0.0254*0.0254*0.0254);
                case VolumeUnit.UsCustomaryCup: return _value*0.0002365882365;
                case VolumeUnit.UsGallon: return _value*(231*0.0254*0.0254*0.0254);
                case VolumeUnit.UsLegalCup: return _value*0.00024;
                case VolumeUnit.UsOunce: return _value*(231*0.0254*0.0254*0.0254*1/128);
                case VolumeUnit.UsPint: return _value*4.73176473e-4;
                case VolumeUnit.UsQuart: return _value*9.46352946e-4;
                case VolumeUnit.UsTablespoon: return _value*(231*0.0254*0.0254*0.0254*1/128*1/2);
                case VolumeUnit.UsTeaspoon: return _value*(231*0.0254*0.0254*0.0254*1/128*1/2*1/3);
                default:
        ...
        private double AsBaseNumericType(VolumeUnit unit)
        {
            ...
            switch(unit)
            {
                case VolumeUnit.AcreFoot: return baseUnitValue/(43560*0.3048*0.3048*0.3048);
                case VolumeUnit.AuTablespoon: return baseUnitValue/2e-5;
                case VolumeUnit.BoardFoot: return baseUnitValue/(0.3048*0.3048*0.0254);
                ...
                case VolumeUnit.CubicFoot: return baseUnitValue/(0.3048*0.3048*0.3048);
                case VolumeUnit.CubicHectometer: return baseUnitValue/1e6;
                case VolumeUnit.CubicInch: return baseUnitValue/(0.0254*0.0254*0.0254);
                ...
                case VolumeUnit.CubicMile: return baseUnitValue/(5280.0*5280.0*5280.0*0.3048*0.3048*0.3048);
                case VolumeUnit.CubicMillimeter: return baseUnitValue*1e9;
                case VolumeUnit.CubicYard: return baseUnitValue/(3*3*3*0.3048*0.3048*0.3048);
                case VolumeUnit.Dec: return baseUnitValue*1000;
                case VolumeUnit.DecausGallon: return (baseUnitValue/(231*0.0254*0.0254*0.0254)) / 1e1d;
                case VolumeUnit.Deciliter: return (baseUnitValue*1e3) / 1e-1d;
                case VolumeUnit.DeciusGallon: return (baseUnitValue/(231*0.0254*0.0254*0.0254)) / 1e-1d;
                case VolumeUnit.HectocubicFoot: return (baseUnitValue/(0.3048*0.3048*0.3048)) / 1e2d;
                case VolumeUnit.HectocubicMeter: return (baseUnitValue) / 1e2d;
                case VolumeUnit.Hectoliter: return (baseUnitValue*1e3) / 1e2d;
                case VolumeUnit.HectousGallon: return (baseUnitValue/(231*0.0254*0.0254*0.0254)) / 1e2d;
                case VolumeUnit.ImperialBeerBarrel: return baseUnitValue/0.16365924;
                case VolumeUnit.ImperialGallon: return baseUnitValue/0.00454609;
                case VolumeUnit.ImperialOunce: return baseUnitValue/(0.00454609*1/160);
                case VolumeUnit.ImperialPint: return baseUnitValue / 5.6826125e-4;
                case VolumeUnit.KilocubicFoot: return (baseUnitValue/(0.3048*0.3048*0.3048)) / 1e3d;
                case VolumeUnit.KilocubicMeter: return (baseUnitValue) / 1e3d;
                case VolumeUnit.KiloimperialGallon: return (baseUnitValue/0.00454609) / 1e3d;
                case VolumeUnit.Kiloliter: return (baseUnitValue*1e3) / 1e3d;
                case VolumeUnit.KilousGallon: return (baseUnitValue/(231*0.0254*0.0254*0.0254)) / 1e3d;
                case VolumeUnit.Liter: return baseUnitValue*1e3;
                case VolumeUnit.MegacubicFoot: return (baseUnitValue/(0.3048*0.3048*0.3048)) / 1e6d;
                case VolumeUnit.MegaimperialGallon: return (baseUnitValue/0.00454609) / 1e6d;
                case VolumeUnit.Megaliter: return (baseUnitValue*1e3) / 1e6d;
                case VolumeUnit.MegausGallon: return (baseUnitValue/(231*0.0254*0.0254*0.0254)) / 1e6d;
                ...
                case VolumeUnit.OilBarrel: return baseUnitValue/(42*231*0.0254*0.0254*0.0254);
                case VolumeUnit.UkTablespoon: return baseUnitValue/1.5e-5;
                case VolumeUnit.UsBeerBarrel: return baseUnitValue/(31*231*0.0254*0.0254*0.0254);
                case VolumeUnit.UsCustomaryCup: return baseUnitValue/0.0002365882365;
                case VolumeUnit.UsGallon: return baseUnitValue/(231*0.0254*0.0254*0.0254);
                case VolumeUnit.UsLegalCup: return baseUnitValue/0.00024;
                case VolumeUnit.UsOunce: return baseUnitValue/(231*0.0254*0.0254*0.0254*1/128);
                case VolumeUnit.UsPint: return baseUnitValue/4.73176473e-4;
                case VolumeUnit.UsQuart: return baseUnitValue/9.46352946e-4;
                case VolumeUnit.UsTablespoon: return baseUnitValue/(231*0.0254*0.0254*0.0254*1/128*1/2);
                case VolumeUnit.UsTeaspoon: return baseUnitValue/(231*0.0254*0.0254*0.0254*1/128*1/2*1/3);
                default:
