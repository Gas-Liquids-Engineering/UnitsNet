    ...
    public sealed partial class Force : IQuantity
    {
        ...
        private double AsBaseUnit()
        {
            switch(Unit)
            {
                ...
                case ForceUnit.KilogramForce: return _value*9.80665;
                case ForceUnit.Kilonewton: return (_value) * 1e3d;
                case ForceUnit.KiloPond: return _value*9.80665;
                case ForceUnit.KilopoundForce: return (_value*(32.174*0.45359237*0.3048)) * 1e3d;
                ...
                case ForceUnit.OunceForce: return _value*(32.174*0.45359237*0.3048/16);
                case ForceUnit.Poundal: return _value*(0.45359237*0.3048);
                case ForceUnit.PoundForce: return _value*(32.174*0.45359237*0.3048);
                case ForceUnit.ShortTonForce: return _value*(32.174*0.45359237*0.3048*2000);
                case ForceUnit.TonneForce: return _value*9.80665e3;
                default:
        ...
        private double AsBaseNumericType(ForceUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case ForceUnit.KilogramForce: return baseUnitValue/9.80665;
                case ForceUnit.Kilonewton: return (baseUnitValue) / 1e3d;
                case ForceUnit.KiloPond: return baseUnitValue/9.80665;
                case ForceUnit.KilopoundForce: return (baseUnitValue/(32.174*0.45359237*0.3048)) / 1e3d;
                ...
                case ForceUnit.OunceForce: return baseUnitValue/(32.174*0.45359237*0.3048/16);
                case ForceUnit.Poundal: return baseUnitValue/(0.45359237*0.3048);
                case ForceUnit.PoundForce: return baseUnitValue/(32.174*0.45359237*0.3048);
                case ForceUnit.ShortTonForce: return baseUnitValue/(32.174*0.45359237*0.3048*2000);
                case ForceUnit.TonneForce: return baseUnitValue/9.80665e3;
                default:
