    ...
    public sealed partial class FuelEfficiency : IQuantity
    {
        ...
        private double AsBaseUnit()
        {
            switch(Unit)
            {
                ...
                case FuelEfficiencyUnit.MilePerUkGallon: return (100*4.54609)/(1.609344*_value);
        ...
        private double AsBaseNumericType(FuelEfficiencyUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case FuelEfficiencyUnit.MilePerUkGallon: return (100*4.54609)/(1.609344*baseUnitValue);
