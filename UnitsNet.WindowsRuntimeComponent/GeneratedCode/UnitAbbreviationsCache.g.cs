    ...
    public sealed partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(CoefficientOfThermalExpansionUnit), (int)CoefficientOfThermalExpansionUnit.InverseRankine, new string[]{"°R⁻¹", "1/°R"}),
                ...
                ("en-US", typeof(DynamicViscosityUnit), (int)DynamicViscosityUnit.Micropoise, new string[]{"µP"}),
                ...
                ("en-US", typeof(DynamicViscosityUnit), (int)DynamicViscosityUnit.PoundPerFootHour, new string[]{"lb/ft·h"}),
                ...
                ("en-US", typeof(EnergyUnit), (int)EnergyUnit.HorsepowerHour, new string[]{"hp·h", "hph"}),
                ...
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.BTUPerCubicFoot, new string[]{"BTU/ft³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.CaloriePerCubicMeter, new string[]{"cal/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.JoulePerCubicMeter, new string[]{"J/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.KilocaloriePerCubicMeter, new string[]{"kcal/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.KilojoulePerCubicMeter, new string[]{"kJ/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.MegajoulePerCubicMeter, new string[]{"MJ/m³"}),
                ("en-US", typeof(EnthalpyMassUnit), (int)EnthalpyMassUnit.BTUPerPound, new string[]{"BTU/lb"}),
                ("en-US", typeof(EnthalpyMassUnit), (int)EnthalpyMassUnit.CaloriePerGram, new string[]{"cal/g"}),
                ("en-US", typeof(EnthalpyMassUnit), (int)EnthalpyMassUnit.JoulePerKilogram, new string[]{"J/kg"}),
                ...
                ("en-US", typeof(EnthalpyMolarUnit), (int)EnthalpyMolarUnit.KilojoulePerKilomole, new string[]{"kJ/kmol"}),
                ("en-US", typeof(EnthalpyMolarUnit), (int)EnthalpyMolarUnit.KilojoulePerMole, new string[]{"kJ/mol"}),
                ("en-US", typeof(EnthalpyMolarUnit), (int)EnthalpyMolarUnit.MegajoulePerMole, new string[]{"MJ/mol"}),
                ...
                ("en-US", typeof(InverseHeatTransferCoefficientUnit), (int)InverseHeatTransferCoefficientUnit.SquareCentimeterKelvinPerWatt, new string[]{"cm²·K/W"}),
                ("en-US", typeof(InverseHeatTransferCoefficientUnit), (int)InverseHeatTransferCoefficientUnit.SquareCentimeterSecondKelvinPerCalorie, new string[]{"cm²·s·K/cal"}),
                ...
                ("en-US", typeof(JouleThomsonCoefficientUnit), (int)JouleThomsonCoefficientUnit.DegreeFahrenheitPerPoundsForcePerSquareInch, new string[]{"°F/psi"}),
                ("en-US", typeof(JouleThomsonCoefficientUnit), (int)JouleThomsonCoefficientUnit.KelvinPerBar, new string[]{"K/bar"}),
                ("en-US", typeof(JouleThomsonCoefficientUnit), (int)JouleThomsonCoefficientUnit.KelvinPerKilopascal, new string[]{"K/kPa"}),
                ...
                ("en-US", typeof(KinematicViscosityUnit), (int)KinematicViscosityUnit.SquareFootPerHour, new string[]{"ft²/h"}),
                ("en-US", typeof(KinematicViscosityUnit), (int)KinematicViscosityUnit.SquareFootPerSecond, new string[]{"ft²/s"}),
                ("en-US", typeof(KinematicViscosityUnit), (int)KinematicViscosityUnit.SquareInchPerSecond, new string[]{"in²/s"}),
                ("en-US", typeof(KinematicViscosityUnit), (int)KinematicViscosityUnit.SquareMeterPerHour, new string[]{"m²/h"}),
                ...
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.BtuPerPoundMoleDegreeFahrenheit, new string[]{"Btu/lbmol-°F"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.CaloriePerMoleKelvin, new string[]{"cal/mol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.JoulePerKilomoleKelvin, new string[]{"J/kmol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.JoulePerMoleKelvin, new string[]{"J/mol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.KilobtuPerPoundMoleDegreeFahrenheit, new string[]{"kBtu/lbmol-°F"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.KilocaloriePerMoleKelvin, new string[]{"kcal/mol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.KilojoulePerKilomoleKelvin, new string[]{"kJ/kmol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.KilojoulePerMoleKelvin, new string[]{"kJ/mol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.MegabtuPerPoundMoleDegreeFahrenheit, new string[]{"MBtu/lbmol-°F"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.MegacaloriePerMoleKelvin, new string[]{"Mcal/mol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.MegajoulePerKilomoleKelvin, new string[]{"MJ/kmol-K"}),
                ("en-US", typeof(MolarEntropyUnit), (int)MolarEntropyUnit.MegajoulePerMoleKelvin, new string[]{"MJ/mol-K"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.GramMolePerHour, new string[]{"g-mol/h"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.GramMolePerMinute, new string[]{"g-mol/min"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.GramMolePerSecond, new string[]{"g-mol/s"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.KilogramMolePerHour, new string[]{"kg-mol/h"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.KilogramMolePerMinute, new string[]{"kg-mol/min"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.KilogramMolePerSecond, new string[]{"kg-mol/s"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.PoundMolePerHour, new string[]{"lb-mol/h"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.PoundMolePerMinute, new string[]{"lb-mol/min"}),
                ("en-US", typeof(MolarFlowUnit), (int)MolarFlowUnit.PoundMolePerSecond, new string[]{"lb-mol/s"}),
                ...
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.KilomolesPerCubicMeter, new string[]{"kmol/m³"}),
                ...
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.PoundMolesPerCubicFoot, new string[]{"lb-mol/ft³"}),
                ("en-US", typeof(MolarityUnit), (int)MolarityUnit.PoundMolesPerCubicMeter, new string[]{"lb-mol/m³"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.CentigramPerKilomole, new string[]{"cg/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.CentigramPerMole, new string[]{"cg/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.DecagramPerKilomole, new string[]{"dag/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.DecagramPerMole, new string[]{"dag/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.DecigramPerKilomole, new string[]{"dg/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.DecigramPerMole, new string[]{"dg/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.GramPerKilomole, new string[]{"g/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.GramPerMole, new string[]{"g/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.GramPerPoundMole, new string[]{"g/lbmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.HectogramPerKilomole, new string[]{"hg/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.HectogramPerMole, new string[]{"hg/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.KilogramPerKilomole, new string[]{"kg/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.KilogramPerMole, new string[]{"kg/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.KilogramPerPoundMole, new string[]{"kg/lbmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.KilopoundPerKilomole, new string[]{"klb/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.KilopoundPerMole, new string[]{"klb/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.KilopoundPerPoundMole, new string[]{"klb/lbmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.MicrogramPerKilomole, new string[]{"µg/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.MicrogramPerMole, new string[]{"µg/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.MilligramPerKilomole, new string[]{"mg/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.MilligramPerMole, new string[]{"mg/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.NanogramPerKilomole, new string[]{"ng/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.NanogramPerMole, new string[]{"ng/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.PoundPerKilomole, new string[]{"lb/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.PoundPerMole, new string[]{"lb/gmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.PoundPerPoundMole, new string[]{"lb/lbmol"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.CaloriesPerHour, new string[]{"cal/h"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.GigacaloriesPerHour, new string[]{"Gcal/h"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.KilocaloriesPerHour, new string[]{"kcal/h"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.MegacaloriesPerHour, new string[]{"Mcal/h"}),
                ...
                ("en-US", typeof(PowerUnit), (int)PowerUnit.MillicaloriesPerHour, new string[]{"mcal/h"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.InchOfWaterColumn, new string[]{"wc", "inH2O"}),
                ...
                ("en-US", typeof(PressureUnit), (int)PressureUnit.MillimeterOfWaterColumn, new string[]{"mmH2O"}),
                ...
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.DecapascalDeltaPerKilometer, new string[]{"daPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.DecapascalDeltaPerMeter, new string[]{"daPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.GigapascalDeltaPerKilometer, new string[]{"GPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.GigapascalDeltaPerMeter, new string[]{"GPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.HectopascalDeltaPerKilometer, new string[]{"hPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.HectopascalDeltaPerMeter, new string[]{"hPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.KilopascalDeltaPerKilometer, new string[]{"kPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.KilopascalDeltaPerMeter, new string[]{"kPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.MegapascalDeltaPerKilometer, new string[]{"MPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.MegapascalDeltaPerMeter, new string[]{"MPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.MicropascalDeltaPerKilometer, new string[]{"µPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.MicropascalDeltaPerMeter, new string[]{"µPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.MillipascalDeltaPerKilometer, new string[]{"mPad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.MillipascalDeltaPerMeter, new string[]{"mPad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.PascalDeltaPerKilometer, new string[]{"Pad/km"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.PascalDeltaPerMeter, new string[]{"Pad/m"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.PoundPerSquareInchDeltaPerFoot, new string[]{"psid/ft"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.PoundPerSquareInchDeltaPerHundredFeet, new string[]{"psid/100ft"}),
                ("en-US", typeof(PressureDeltaPerUnitLengthUnit), (int)PressureDeltaPerUnitLengthUnit.PoundPerSquareInchDeltaPerMile, new string[]{"psid/mi"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.CentiradianPerMinute, new string[]{"crad/min"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.DeciradianPerMinute, new string[]{"drad/min"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.DegreePerHour, new string[]{"°/h", "deg/h"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.MicrodegreePerHour, new string[]{"µ°/h", "µdeg/h"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.MicroradianPerMinute, new string[]{"µrad/min"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.MillidegreePerHour, new string[]{"m°/h", "mdeg/h"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.MilliradianPerMinute, new string[]{"mrad/min"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.NanodegreePerHour, new string[]{"n°/h", "ndeg/h"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.NanoradianPerMinute, new string[]{"nrad/min"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.RadianPerMinute, new string[]{"rad/min"}),
                ...
                ("en-US", typeof(RotationalSpeedUnit), (int)RotationalSpeedUnit.RevolutionPerHour, new string[]{"r/h"}),
                ...
                ("en-US", typeof(SpecificEntropyUnit), (int)SpecificEntropyUnit.BtuPerPoundFahrenheit, new string[]{"BTU/lb.°F", "BTU/lbm.°F", "BTU/lb·°F", "BTU/lbm·°F"}),
                ("en-US", typeof(SpecificEntropyUnit), (int)SpecificEntropyUnit.CaloriePerGramKelvin, new string[]{"cal/g.K", "cal/g·K"}),
                ("en-US", typeof(SpecificEntropyUnit), (int)SpecificEntropyUnit.JoulePerKilogramDegreeCelsius, new string[]{"J/kg.C", "J/kg·C"}),
                ("en-US", typeof(SpecificEntropyUnit), (int)SpecificEntropyUnit.JoulePerKilogramKelvin, new string[]{"J/kg.K", "J/kg·K"}),
                ("en-US", typeof(SpecificEntropyUnit), (int)SpecificEntropyUnit.KilocaloriePerGramKelvin, new string[]{"kcal/g.K", "kcal/g·K"}),
                ("en-US", typeof(SpecificEntropyUnit), (int)SpecificEntropyUnit.KilojoulePerKilogramDegreeCelsius, new string[]{"kJ/kg.C", "kJ/kg·C"}),
                ...
                ("en-US", typeof(SpecificEntropyMolarUnit), (int)SpecificEntropyMolarUnit.KilojoulePerKilomoleKelvin, new string[]{"kJ/kmol.K", "kJ/kmol·K"}),
                ("en-US", typeof(SpecificEntropyMolarUnit), (int)SpecificEntropyMolarUnit.KilojoulePerMoleKelvin, new string[]{"kJ/mol.K", "kJ/mol·K"}),
                ("en-US", typeof(SpecificEntropyMolarUnit), (int)SpecificEntropyMolarUnit.MegajoulePerKilomoleKelvin, new string[]{"MJ/kmol.K", "MJ/kmol·K"}),
                ("en-US", typeof(SpecificEntropyMolarUnit), (int)SpecificEntropyMolarUnit.MegajoulePerMoleKelvin, new string[]{"MJ/mol.K", "MJ/mol·K"}),
                ...
                ("en-US", typeof(SpecificVolumeUnit), (int)SpecificVolumeUnit.LiterPerGram, new string[]{"L/g"}),
                ("en-US", typeof(SpecificVolumeUnit), (int)SpecificVolumeUnit.MillicubicMeterPerKilogram, new string[]{"mm³/kg"}),
                ("en-US", typeof(SpecificVolumeUnit), (int)SpecificVolumeUnit.MilliliterPerGram, new string[]{"mL/g"}),
                ("en-US", typeof(SpecificVolumeUnit), (int)SpecificVolumeUnit.USGallonPerPound, new string[]{"gal (U.S.)/lb"}),
                ...
                ("en-US", typeof(SpeedUnit), (int)SpeedUnit.MilePerHour, new string[]{"mph", "mi/h"}),
                ...
                ("en-US", typeof(VolumeUnit), (int)VolumeUnit.Dec, new string[]{"e³m³"}),
                ...
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.CubicFootPerDay, new string[]{"ft³/d", "cf/d"}),
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.CubicFootPerHour, new string[]{"ft³/h", "cf/hr"}),
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.CubicFootPerMinute, new string[]{"ft³/min", "CFM"}),
                ...
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.DecPerDay, new string[]{"e³m³/d", "decs/d"}),
                ...
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.OilBarrelPerDay, new string[]{"bbl/d", "BOPD", "BPD"}),
                ...
                ("en-US", typeof(VolumeFlowUnit), (int)VolumeFlowUnit.ThousandCubicFootPerDay, new string[]{"e³ft³/d", "e³cf/d"}),
                ...
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.BtuPerCubicFootDegreeFahrenheit, new string[]{"BTU/ft³·°F"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.CaloriePerCubicCentimeterDegreeCelsius, new string[]{"cal/cm³·°C"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.JoulePerCubicMeterDegreeCelsius, new string[]{"J/m³·°C"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.JoulePerCubicMeterKelvin, new string[]{"J/m³·K"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.KilocaloriePerCubicCentimeterDegreeCelsius, new string[]{"kcal/cm³·°C"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.KilojoulePerCubicMeterDegreeCelsius, new string[]{"kJ/m³·°C"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.KilojoulePerCubicMeterKelvin, new string[]{"kJ/m³·K"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.MegajoulePerCubicMeterDegreeCelsius, new string[]{"MJ/m³·°C"}),
                ("en-US", typeof(VolumetricHeatCapacityUnit), (int)VolumetricHeatCapacityUnit.MegajoulePerCubicMeterKelvin, new string[]{"MJ/m³·K"}),
