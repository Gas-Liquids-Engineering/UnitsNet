    ...
    public struct  LinearPowerDensity
    {
        ...
        private double GetValueInBaseUnit()
        {
            switch(Unit)
            {
                ...
                case LinearPowerDensityUnit.GigawattPerFoot: return (_value*(1/0.3048)) * 1e9d;
                case LinearPowerDensityUnit.GigawattPerInch: return (_value*(1/0.0254)) * 1e9d;
                ...
                case LinearPowerDensityUnit.KilowattPerFoot: return (_value*(1/0.3048)) * 1e3d;
                case LinearPowerDensityUnit.KilowattPerInch: return (_value*(1/0.0254)) * 1e3d;
                ...
                case LinearPowerDensityUnit.MegawattPerFoot: return (_value*(1/0.3048)) * 1e6d;
                case LinearPowerDensityUnit.MegawattPerInch: return (_value*(1/0.0254)) * 1e6d;
                ...
                case LinearPowerDensityUnit.MilliwattPerFoot: return (_value*(1/0.3048)) * 1e-3d;
                case LinearPowerDensityUnit.MilliwattPerInch: return (_value*(1/0.0254)) * 1e-3d;
                ...
                case LinearPowerDensityUnit.WattPerFoot: return _value*(1/0.3048);
                case LinearPowerDensityUnit.WattPerInch: return _value*(1/0.0254);
        ...
        private double GetValueAs(LinearPowerDensityUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case LinearPowerDensityUnit.GigawattPerFoot: return (baseUnitValue/(1/0.3048)) / 1e9d;
                case LinearPowerDensityUnit.GigawattPerInch: return (baseUnitValue/(1/0.0254)) / 1e9d;
                ...
                case LinearPowerDensityUnit.KilowattPerFoot: return (baseUnitValue/(1/0.3048)) / 1e3d;
                case LinearPowerDensityUnit.KilowattPerInch: return (baseUnitValue/(1/0.0254)) / 1e3d;
                ...
                case LinearPowerDensityUnit.MegawattPerFoot: return (baseUnitValue/(1/0.3048)) / 1e6d;
                case LinearPowerDensityUnit.MegawattPerInch: return (baseUnitValue/(1/0.0254)) / 1e6d;
                ...
                case LinearPowerDensityUnit.MilliwattPerFoot: return (baseUnitValue/(1/0.3048)) / 1e-3d;
                case LinearPowerDensityUnit.MilliwattPerInch: return (baseUnitValue/(1/0.0254)) / 1e-3d;
                ...
                case LinearPowerDensityUnit.WattPerFoot: return baseUnitValue/(1/0.3048);
                case LinearPowerDensityUnit.WattPerInch: return baseUnitValue/(1/0.0254);
