...
namespace UnitsNet
{
    ...
    public struct  HeatFlux
    {
        ...
        private double GetValueInBaseUnit()
        {
            switch(Unit)
            {
                case HeatFluxUnit.BtuPerHourSquareFoot: return _value*(1055.05585262*1/3600*1/0.3048*1/0.3048);
                case HeatFluxUnit.BtuPerMinuteSquareFoot: return _value*(1055.05585262*1/60*1/0.3048*1/0.3048);
                case HeatFluxUnit.BtuPerSecondSquareFoot: return _value*(1055.05585262*1/0.3048*1/0.3048);
                case HeatFluxUnit.BtuPerSecondSquareInch: return _value*(1055.05585262*1/0.0254*1/0.0254);
                ...
                case HeatFluxUnit.PoundForcePerFootSecond: return _value*(32.174*0.45359237);
                case HeatFluxUnit.PoundPerSecondCubed: return _value*4.5359237e-1;
                case HeatFluxUnit.WattPerSquareFoot: return _value/(0.3048*0.3048);
                case HeatFluxUnit.WattPerSquareInch: return _value/(0.0254*0.0254);
        ...
        private double GetValueAs(HeatFluxUnit unit)
        {
            ...
            switch(unit)
            {
                case HeatFluxUnit.BtuPerHourSquareFoot: return baseUnitValue/(1055.05585262*1/3600*1/0.3048*1/0.3048);
                case HeatFluxUnit.BtuPerMinuteSquareFoot: return baseUnitValue/(1055.05585262*1/60*1/0.3048*1/0.3048);
                case HeatFluxUnit.BtuPerSecondSquareFoot: return baseUnitValue/(1055.05585262*1/0.3048*1/0.3048);
                case HeatFluxUnit.BtuPerSecondSquareInch: return baseUnitValue/(1055.05585262*1/0.0254*1/0.0254);
                ...
                case HeatFluxUnit.PoundForcePerFootSecond: return baseUnitValue/(32.174*0.45359237);
                case HeatFluxUnit.PoundPerSecondCubed: return baseUnitValue/4.5359237e-1;
                case HeatFluxUnit.WattPerSquareFoot: return baseUnitValue*(0.3048*0.3048);
                case HeatFluxUnit.WattPerSquareInch: return baseUnitValue*(0.0254*0.0254);
