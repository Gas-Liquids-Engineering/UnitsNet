    ...
    public partial struct Power : IQuantity<PowerUnit>, IDecimalQuantity, IEquatable<Power>, IComparable, IComparable<Power>, IConvertible, IFormattable
    {
        ...
        private decimal GetValueInBaseUnit()
        {
            switch(Unit)
            {
                ...
                case PowerUnit.BritishThermalUnitPerHour: return _value*(1055.05585262/3600);
                case PowerUnit.CaloriesPerHour: return _value*(4.184/3600);
                ...
                case PowerUnit.GigacaloriesPerHour: return (_value*(4.184/3600)) * 1e9m;
                case PowerUnit.GigajoulePerHour: return (_value/3600m) * 1e9m;
                case PowerUnit.Gigawatt: return (_value) * 1e9m;
                case PowerUnit.HydraulicHorsepower: return _value*(550*32.174*0.45359237*0.3048*0.3048);
                case PowerUnit.JoulePerHour: return _value/3600m;
                case PowerUnit.KilobritishThermalUnitPerHour: return (_value*(1055.05585262/3600)) * 1e3m;
                case PowerUnit.KilocaloriesPerHour: return (_value*(4.184/3600)) * 1e3m;
                ...
                case PowerUnit.MegacaloriesPerHour: return (_value*(4.184/3600)) * 1e6m;
                ...
                case PowerUnit.MillicaloriesPerHour: return (_value*(4.184/3600)) * 1e-3m;
        ...
        private decimal GetValueAs(PowerUnit unit)
        {
            ...
            switch(unit)
            {
                ...
                case PowerUnit.BritishThermalUnitPerHour: return baseUnitValue/(1055.05585262/3600);
                case PowerUnit.CaloriesPerHour: return baseUnitValue/(4.184/3600);
                ...
                case PowerUnit.GigacaloriesPerHour: return (baseUnitValue/(4.184/3600)) / 1e9m;
                case PowerUnit.GigajoulePerHour: return (baseUnitValue*3600m) / 1e9m;
                case PowerUnit.Gigawatt: return (baseUnitValue) / 1e9m;
                case PowerUnit.HydraulicHorsepower: return baseUnitValue/(550*32.174*0.45359237*0.3048*0.3048);
                case PowerUnit.JoulePerHour: return baseUnitValue*3600m;
                case PowerUnit.KilobritishThermalUnitPerHour: return (baseUnitValue/(1055.05585262/3600)) / 1e3m;
                case PowerUnit.KilocaloriesPerHour: return (baseUnitValue/(4.184/3600)) / 1e3m;
                ...
                case PowerUnit.MegacaloriesPerHour: return (baseUnitValue/(4.184/3600)) / 1e6m;
                ...
                case PowerUnit.MillicaloriesPerHour: return (baseUnitValue/(4.184/3600)) / 1e-3m;
