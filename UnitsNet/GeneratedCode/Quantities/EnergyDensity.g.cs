...
namespace UnitsNet
{
    ...
    /// </summary>
    public partial struct EnergyDensity : IQuantity<EnergyDensityUnit>, IEquatable<EnergyDensity>, IComparable, IComparable<EnergyDensity>, IConvertible, IFormattable
    {
        /// <summary>
        ...
        public static QuantityType QuantityType { get; } = QuantityType.EnergyDensity;
        ...
        {
            return new EnergyDensity(left.Value + right.GetValueAs(left.Unit), left.Unit);
        }
        ...
        /// <remarks>Consider using <see cref="Equals(EnergyDensity, double, ComparisonType)"/> for safely comparing floating point values.</remarks>
        public static bool operator ==(EnergyDensity left, EnergyDensity right)
        {
        ...
        {
            if(!(unit is EnergyDensityUnit unitAsEnergyDensityUnit))
            ...
            return As(unitAsEnergyDensityUnit);
        }
        ...
        IQuantity IQuantity.ToUnit(Enum unit)
        {
            ...
            return ToUnit(unitAsEnergyDensityUnit);
        }
        ...
        /// </summary>
        /// <returns>The value in the base unit representation.</returns>
        internal EnergyDensity ToBaseUnit()
        {
            var baseUnitValue = GetValueInBaseUnit();
            return new EnergyDensity(baseUnitValue, BaseUnit);
        }
        ...
        object IConvertible.ToType(Type conversionType, IFormatProvider provider)
        {
            if(conversionType == typeof(EnergyDensity))
                ...
                return EnergyDensity.QuantityType;
