...
namespace UnitsNet
{
    public sealed partial class UnitConverter
    {
        ...
        public static void RegisterDefaultConversions(UnitConverter unitConverter)
        {
            ...
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Centisecond, q => q.ToUnit(TimeUnit.Centisecond));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Centisecond, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Day, q => q.ToUnit(TimeUnit.Day));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Day, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Decisecond, q => q.ToUnit(TimeUnit.Decisecond));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Decisecond, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Hour, q => q.ToUnit(TimeUnit.Hour));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Hour, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Kilosecond, q => q.ToUnit(TimeUnit.Kilosecond));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Kilosecond, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Microsecond, q => q.ToUnit(TimeUnit.Microsecond));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Microsecond, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Millisecond, q => q.ToUnit(TimeUnit.Millisecond));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Millisecond, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Minute, q => q.ToUnit(TimeUnit.Minute));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Minute, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, TimeUnit.Nanosecond, q => q.ToUnit(TimeUnit.Nanosecond));
            unitConverter.SetConversionFunction<Time>(TimeUnit.Nanosecond, Time.BaseUnit, q => q.ToBaseUnit());
            unitConverter.SetConversionFunction<Time>(Time.BaseUnit, Time.BaseUnit, q => q);
