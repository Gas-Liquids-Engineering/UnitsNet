    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.MegapoundPerKilomole, new string[]{"Mlb/kgmol"}),
                ("en-US", typeof(MolarMassUnit), (int)MolarMassUnit.MegapoundPerMole, new string[]{"Mlb/gmol"}),
