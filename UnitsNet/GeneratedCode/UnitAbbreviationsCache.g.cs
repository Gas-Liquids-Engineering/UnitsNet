    ...
    public partial class UnitAbbreviationsCache
    {
        private static readonly (string CultureName, Type UnitType, int UnitValue, string[] UnitAbbreviations)[] GeneratedLocalizations
            = new []
            {
                ...
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.BtusPerCubicFoot, new string[]{"Btu/ft³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.CaloriesPerCubicMeter, new string[]{"Cal/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.JoulesPerCubicMeter, new string[]{"J/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.KilocaloriesPerCubicMeter, new string[]{"kCal/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.KilojoulesPerCubicMeter, new string[]{"kJ/m³"}),
                ("en-US", typeof(EnergyDensityUnit), (int)EnergyDensityUnit.MegajoulesPerCubicMeter, new string[]{"MJ/m³"}),
                ...
                ("en-US", typeof(EnthalpyMolarUnit), (int)EnthalpyMolarUnit.BtuPerPound, new string[]{"btu/lb-mol"}),
                ...
                ("en-US", typeof(InverseTemperatureUnit), (int)InverseTemperatureUnit.InverseDegreeRankine, new string[]{"1/°R"}),
                ("en-US", typeof(InverseTemperatureUnit), (int)InverseTemperatureUnit.InverseKelvin, new string[]{"1/K"}),
                ...
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Centisecond, new string[]{"cs"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Day, new string[]{"d"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Decisecond, new string[]{"ds"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Hour, new string[]{"h"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Kilosecond, new string[]{"ks"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Microsecond, new string[]{"µs"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Millisecond, new string[]{"ms"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Minute, new string[]{"min"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Nanosecond, new string[]{"ns"}),
                ("en-US", typeof(TimeUnit), (int)TimeUnit.Second, new string[]{"s"}),
